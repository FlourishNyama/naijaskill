  ...
  return (
    <main className="min-h-screen bg-[#FAF7F2] dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* ══════════════════════════════════════════
          ...
          Original Supabase query + all classNames preserved
      ══════════════════════════════════════════ */}
      <section className="py-12 md:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-6 md:mb-8">
          <div>
            <span className="text-[#C9973A] text-xs font-bold uppercase tracking-widest mb-1 block">Top Rated</span>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Featured Skilled Workers</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {featuredArtisans.length === 0 ? (
              <p className="text-gray-500 col-span-3 text-center py-10">
                No skilled worker found yet. Be the first to join!
              </p>
            ) : (
              featuredArtisans.map((artisan) => (
                <Link
                  ...
                  key={artisan.id}
                  className="block group bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-[#C9973A]/40 dark:hover:border-[#C9973A]/40 hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer"
                >
                  <div className="h-48 w-full bg-gray-100 dark:bg-slate-800 relative">
                    ...
                    <div className="absolute top-3 right-3 bg-white/90 backdrop-blur text-green-700 text-xs font-bold px-2.5 py-1 rounded-full flex items-center shadow-sm">
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start">
                      <div className="min-w-0 pr-2">
                        ...
                        <p className="text-sm text-green-600 dark:text-green-400 font-medium">{artisan.job_title || "Skilled Worker"}</p>
                      </div>
                      <div className="flex items-center bg-yellow-50 dark:bg-yellow-900/20 px-2 py-1 rounded-md flex-shrink-0">
                    ...
                    <div className="mt-4 flex items-center text-gray-500 dark:text-gray-400 text-sm">
                      ...
                      <span className="truncate">{artisan.location || "Nigeria"}</span>
                    </div>
                    <div className="mt-6 flex items-center justify-between border-t border-gray-100 dark:border-gray-800 pt-4">
                      <span className="text-lg font-bold text-gray-900 dark:text-white">
                        ₦{artisan.hourly_rate?.toLocaleString() || "N/A"}
                        <span className="text-sm text-gray-400 font-normal">/hr</span>
                      </span>
                      <button className="bg-[#1D5C30] dark:bg-green-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#2A7A3F] dark:hover:bg-green-700 transition-colors active:scale-95">
                        Book Now
                      </button>
                    </div>
                  </div>
