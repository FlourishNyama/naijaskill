          ...
          <div className="p-4 md:p-6 flex flex-col md:flex-row gap-4 md:gap-6 md:items-center">
            <div className="flex items-start gap-4 flex-1">
              ...
              <div>
                ...
                <div className="flex items-center text-xs text-gray-400 gap-3">
                  <span className="flex items-center"><MapPin className="w-3 h-3 mr-1" /> Lekki Phase 1</span>
                  <span className="flex items-center"><Calendar className="w-3 h-3 mr-1" /> Tomorrow, 9 AM</span>
                </div>
              </div>
            </div>
            <div className="flex flex-row md:flex-col items-center md:items-end justify-between gap-4 md:gap-2 border-t md:border-t-0 border-gray-100 dark:border-gray-800 pt-4 md:pt-0">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                ...
                <button className="flex-1 md:flex-none px-6 py-2 bg-green-600 text-white rounded-lg text-sm font-bold hover:bg-green-700 shadow-lg shadow-green-500/20 flex items-center justify-center">
